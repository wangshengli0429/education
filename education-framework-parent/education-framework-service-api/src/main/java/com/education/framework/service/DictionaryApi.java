...
public interface DictionaryApi {
     ...
     * @return
     */
    ApiResponse<Integer> save(DictionaryBo dictionaryBo);
     ...
     * @return
     */
    ApiResponse<Integer> updateById(DictionaryBo dictionaryBo);
     ...
     * @return
     */
    ApiResponse<List<DictionaryBo>> getListByCodes(List<String> codes);
