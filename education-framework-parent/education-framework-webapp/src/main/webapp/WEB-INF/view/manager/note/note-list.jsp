...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    <!-- 内容主体区域 -->
    	...
    	<table class="layui-hide" id="dataTable" lay-filter="note"></table>
...
layui.use('table', function(){
  ...
  table.render({
	    ...
	    height: 450,
	    url: '${path}/query/note',    //数据接口
	    page: true, //开启分页
	    cols: [[ //表头
	       {field: 'noteContent', title: '留言内容', width:500, sort: true,align:'center', fixed: 'left'}
	      ,{field: 'userId', title: '评论人', align:'center',width:140}
// 	      ,{field: 'teacherName', title: '被评论人', align:'center',width:140}
	      ,{field: 'noteTime', title: '评论时间', align:'center',width:180,
	    	  templet:function(row){
	    		  return DateFormat(row.noteTime,'yyyy-MM-dd HH:mm:ss');
	    	 }  
	      } 
